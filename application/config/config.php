...
define('HTTP_SWF_PATH', $config['base_url'].'assets/swf/playback.swf');

// JQWidget Livrary path
define('HTTP_JQX_JS_PATH', $config['base_url'].'assets/jqx/scripts/');
define('HTTP_JQX_JSW_PATH', $config['base_url'].'assets/jqx/jqwidgets/');
define('HTTP_JQX_IMAGE_PATH', $config['base_url'].'assets/jqx/images/');
define('HTTP_JQX_CSS_PATH', $config['base_url'].'assets/jqx/jqwidgets/styles/');
