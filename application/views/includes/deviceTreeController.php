 ...
 * File Name		: file_name
 * Description		: 
 * Date				: Sep 20, 2014 5:07:50 AM
 * Version			: 1.0
 ********************************************************************************************/
?>
<script type="text/javascript">
var demoApp = angular.module("demoApp", ['timer', 'hashKeyCopier', 'jqwidgets']);	
demoApp.factory('$AllInfoService', function($http) {
	...
	function deviceTreeController($scope, $timeout, $http, $HashKeyCopier, $AllInfoService) {
	...
	deviceTreeController.$inject = [ '$scope', '$timeout', '$http', 'HashKeyCopier', '$AllInfoService' ];
</script>