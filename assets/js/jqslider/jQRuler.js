 ...
 (function($){
	...
	$.widget("ui.ruler", {
		...
		_createTick: function(start, end, scaleOptions){
			var container = $("<div class='ui-ruler-tick' style='display:inline-block; top: 0px; height: 10px;' />"),
			...
			if ( scaleOptions.isgap == true ) {
				container.addClass( scaleOptions.formats[ scaleOptions.gapinfo[scaleOptions.itickcount * 1] * 1] );
			}
